...
class MiceControllerTest < ActionController::TestCase
  ...
  test "should create mouse" do
    assert_difference('Mouse.count') do
      post :create, mouse: { create: @mouse.create, destroy: @mouse.destroy, edit: @mouse.edit, index: @mouse.index, new: @mouse.new }
    end
  ...
  test "should update mouse" do
    patch :update, id: @mouse, mouse: { create: @mouse.create, destroy: @mouse.destroy, edit: @mouse.edit, index: @mouse.index, new: @mouse.new }
    assert_redirected_to mouse_path(assigns(:mouse))
  end
